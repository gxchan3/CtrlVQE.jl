...
fn = "trace.$mole.fixedFrequencyTunableCoupling.W.$W.T.$T.r.$r.initg.$init_g.maxiter.$maxiter.m.$m.dist.$dist.jld2"
subdir = "$dir/molecular_hamiltonian/fixedFrequencyTunableCoupling/$(mole)_$(dist)"
fn_fp = "$subdir/$fn"
if isdir(subdir)
    if isfile(fn_fp)
